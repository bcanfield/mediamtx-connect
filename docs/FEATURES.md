...
- **Localized README** — `README.md` (English source) + `README.es.md` (Spanish) + `README.zh.md` (Simplified Chinese). Each carries a one-line language strip at the top. Developer-facing docs (this file, `CONTRIBUTING.md`, `ARCHITECTURE.md`, `CLAUDE.md`, etc.) intentionally remain English-only.
