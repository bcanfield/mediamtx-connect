...
- **Localized README** — `README.md` (English source) + `README.es.md` (Spanish) + `README.zh.md` (Simplified Chinese) + `README.it.md` (Italian) + `README.de.md` (German) + `README.ru.md` (Russian) + `README.fr.md` (French) + `README.pt.md` (Portuguese) + `README.ja.md` (Japanese) + `README.pl.md` (Polish). Each carries a one-line language strip at the top. Developer-facing docs (this file, `CONTRIBUTING.md`, `ARCHITECTURE.md`, `CLAUDE.md`, etc.) intentionally remain English-only.
