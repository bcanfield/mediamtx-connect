...
2026-07-26: both files now carry reciprocal pointer comments naming the shared keys (api, hls, webrtc, webrtcAdditionalHosts, pathDefaults, `all_others`). That is a reader-facing guard, not enforcement — the duplication and the drift risk are unchanged.
