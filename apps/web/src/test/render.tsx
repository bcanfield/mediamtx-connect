...
export async function renderWithProviders(ui: ReactNode, { path = '/' }: RenderOptions = {}) {
  ...
  const result = render(
    <QueryClientProvider client={queryClient}>
      <IntlProvider locale="en" messages={messages} timeZone="UTC" now={new Date('2026-07-27T12:00:00Z')}>
        {/* Mirrors main.tsx's stack: mutation success/failure is reported by a
            toast, and the Toaster reads the theme. */}
        <ThemeProvider>
